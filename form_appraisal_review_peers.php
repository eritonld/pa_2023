            ...
            <div class="tab-content" id="main_form">
			  ...
			  <h4 class="text-center">Culture Value of SIGAP</h4>
                ...
                <ul class="list-inline pull-right">
                  <li><button type="button" class="btn btn-default prev-step" onclick="window.location.href = '/pa_2023/home.php?link=mydata';">Cancel</button></li>
...
<script>
		...
		function checkLeadership() {
			...
			if (!foundEmpty) {
				let confirm = window.confirm("Penilaian akan di Submit, setelah di Submit maka penilaian sudah tidak dapat di revisi kembali. klik OK untuk melanjutkan dan klik Cancel apabila ada yang belum sesuai.");
				if (confirm){
					document.getElementById('addAppraisal').submit();
				}
			}
