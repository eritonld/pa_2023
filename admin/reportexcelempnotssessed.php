...
where k.Kode_StatusKerja<>'SKH05' $where and k.Mulai_Bekerja <= '$cutoff' and k.NIK not in (select nik from $transaksi_pa where input_by<>'') order by k.kode_ou asc, k.Nama_Lengkap ASC");
