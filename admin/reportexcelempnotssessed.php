...
where k.Kode_StatusKerja<>'SKH05' $where and k.Mulai_Bekerja <= '$cutoff' and k.id not in (select idkar from $transaksi_pa where created_by<>'') order by k.kode_ou asc, k.Nama_Lengkap ASC");
