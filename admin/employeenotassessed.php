        ...
        <div class="box-body">
			<table id="daftar_table" class="table table-bordered table-striped">
				...
				<tbody>
					...
					where k.Kode_StatusKerja<>'SKH05' $where and k.Mulai_Bekerja <= '$cutoff' and k.NIK not in (select nik from $transaksi_pa where input_by<>'') order by k.Nama_Lengkap ASC");
