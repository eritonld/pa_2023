                ...
                <div class="row">
					...
					<div class="container-fluid" style="margin-bottom: 20px;">
                        ...
                        <div class="row" style="margin-top: 30px;">
                            <div class="form-horizontal">
                                <div class="col-md-offset-1 col-md-6" style="padding-right: 0;">
                                    <h1 class="h4"><?= $title_comment; ?> L2 : </h1>
                                    <textarea class="form-control" style="resize: none; height: 100px;" placeholder="<?= $comment_placeholder; ?>..." readonly><?= $comment_a2; ?></textarea>
                                </div>
                            </div>
                        </div>
						<div class="row" style="margin-top: 70px;">
							<div class="form-horizontal">
								...
								<div class="col-md-2" style="padding-right: 0;">
									<select class="form-control text-center" name="rating" id="rating" style="background: #FFFFCC;">
										...
										<option value="5" <?= convertRating($rating_a3) == "A" ? "selected" : ""; ?>>A</option>
										<option value="4" <?= convertRating($rating_a3) == "B" ? "selected" : ""; ?>>B</option>
                        ...
                        <div class="row" style="margin-top: 20px;">
                            <div class="form-horizontal">
                                <div class="col-md-offset-1 col-md-6" style="padding-right: 0;">
                                    ...
                                    <textarea class="form-control" name="comment" id="comment" style="resize: none; height: 100px; background: #FFFFCC;" placeholder="<?= $comment_placeholder; ?>..."><?= $comment_a3; ?></textarea>
                                </div>
                            </div>
                        </div>
					</div>
					...
					<div class="container-fluid container-leadership">
							...
							foreach ($leadershipValue as $data) { 
								...
								<div class="row">
									...
									<div class="col-md-3">
                                        <input type="text" class="form-control" value="<?= $leadership[$data['name'].$lNumber]; ?>" readonly>
									</div>
								</div>
								<?php
								}
