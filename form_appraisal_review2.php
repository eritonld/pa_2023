...
<form name="updateAppraisal" id="updateAppraisal" method="POST" action="apiController.php?code=submitReviewA2" onsubmit="return cekEmptyValue()">
					...
					<div class="container-fluid" style="margin-bottom: 20px;">
						...
						<div class="row" style="margin-top: 50px;">
							<div class="form-horizontal">
								...
								<div class="col-md-2" style="padding-right: 0;">
                                    <input type="text" class="form-control text-center" value="<?= $promotion_a1; ?>" readonly>
								</div>
							</div>
						</div>
						<div class="row" style="margin-top: 50px;">
                        ...
                        <div class="row" style="margin-top: 30px;">
                            <div class="form-horizontal">
                                <div class="col-md-offset-1 col-md-6" style="padding-right: 0;">
                                    <h1 class="h4"><?= $title_comment; ?> L1 : </h1>
                                    <textarea class="form-control" style="resize: none; height: 100px;" placeholder="<?= $comment_placeholder; ?>..." readonly><?= $comment_a1; ?></textarea>
                                </div>
                            </div>
                        </div>
							...
							<div class="form-horizontal">
								...
								<div class="col-md-2" style="padding-right: 0;">
									<select class="form-control text-center" name="rating" id="rating" style="background: #FFFFCC;">
										...
										<option value="5" <?= convertRating($rating_a2) == "A" ? "selected" : ""; ?>>A</option>
										<option value="4" <?= convertRating($rating_a2) == "B" ? "selected" : ""; ?>>B</option>
										<option value="3" <?= convertRating($rating_a2) == "C" ? "selected" : ""; ?>>C</option>
										<option value="2" <?= convertRating($rating_a2) == "D" ? "selected" : ""; ?>>D</option>
										<option value="1" <?= convertRating($rating_a2) == "E" ? "selected" : ""; ?>>E</option>
									</select>
								</div>
							</div>
						</div>
							...
							<div class="form-horizontal">
								...
								<div class="col-md-2" style="padding-right: 0;">
									<select class="form-control text-center" name="promotion" id="promotion" style="background: #FFFFCC;">
										...
										<option value="Y" <?= $promotion_a2 == "Y" ? "selected" : ""; ?>>Yes</option>
										<option value="N" <?= $promotion_a2 == "N" ? "selected" : ""; ?>>No</option>
									</select>
								</div>
							</div>
						</div>
                        <div class="row" style="margin-top: 20px;">
                            <div class="form-horizontal">
                                <div class="col-md-offset-1 col-md-6" style="padding-right: 0;">
                                    ...
                                    <textarea class="form-control" name="comment" id="comment" style="resize: none; height: 100px; background: #FFFFCC;" placeholder="<?= $comment_placeholder; ?>..."><?= $comment_a2; ?></textarea>
                                </div>
                            </div>
                        </div>
					</div>
						...
						<?php
							...
							?>
								<div class="row" style="margin-bottom: 20px;">
									...
									<div class="col-md-3">
                                        <input type="hidden" name="<?= $data['name'].$cNumber; ?>" class="form-control" value="<?= $culture[$data['name'].$cNumber]; ?>" readonly>
                                        <input type="text" class="form-control" value="<?= convertCulture($culture[$data['name'].$cNumber]); ?>" readonly>
									</div>
								</div>
							<?php
							}
					...
					<div class="container-fluid container-leadership">
							...
							foreach ($leadershipValue as $data) { 
								...
								<div class="row">
									...
									<div class="col-md-3">
										<input type="hidden" name="<?= $data['name'].$lNumber; ?>" class="form-control" value="<?= $leadership[$data['name'].$lNumber]; ?>" readonly>
                                        <input type="text" class="form-control" value="<?= convertCulture($leadership[$data['name'].$lNumber]); ?>" readonly>
									</div>
								</div>
								<?php
								}
